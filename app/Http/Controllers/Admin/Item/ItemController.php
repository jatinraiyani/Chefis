...
class ItemController extends Controller
{
    ...
    public function create()
    {
        ...
        $category = ['' => 'Select Category'] + Category::where('status','active')->pluck('category_name','id')->all();
        $cuisine = Cuisines::where('status','active')->get();
        return view('Admin.Item.create',compact('chef','category','cuisine'));
    }
...
//            'category_id'=>'required',
    ...
    public function edit($id)
    {
        ...
        return view('Admin.Item.edit',compact('data','chef','category','item_time','cuisine','item_cuisine','item_on_demands'));
    }
...
//            'category_id'=>'required',
    ...
    public function destroy($id)
    {
        ...
        $itemOnDemand = ItemOnDemand::where('item_id', $id)->delete();
        $itemCuisine = ItemCuisine::where('item_id', $id)->delete();
    ...
    public function GetCategoryData(Request $request){
        $id = $request['id'];
        $data = Category::where('chef_id', $id)->get();
