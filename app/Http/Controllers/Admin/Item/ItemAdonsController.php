...
class ItemAdonsController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('Admin.Item.Adons.index', compact('data', 'id'));
    }

    public function create($id)
    {
        return view('Admin.Item.Adons.create', compact('id'));
    }
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($adons->save()) {
            ...
            return redirect('admin/item/' . $id . '/adons');
        }
    ...
    public function edit($item, $id)
    {
        ...
        return view('Admin.Item.Adons.edit', compact('id', 'data', 'subdata', 'item'));
    ...
    public function update(Request $request, $item, $id)
    {
        ...
        if ($adons) {
            ...
            return redirect('admin/item/' . $item . '/adons');
        }
