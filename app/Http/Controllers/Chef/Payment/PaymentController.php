...
namespace App\Http\Controllers\Chef\Payment;
...
class PaymentController extends Controller
{
    public function index(){
        ...
        return view('Chef.Payment.index',compact('data','total'));
    }

    public function edit($id){
        $data = Payment::findorFail($id);
        return view('Chef.Payment.edit',compact('data'));
    }
    ...
    public function update(Request $request,$id){
        ...
        if($payment){
            ...
            return redirect('chef-admin/payment');
        }
    }
