...
@section('front_title') Trending Items @endsection
@section('front_css')
@endsection
@section('content')
    <section class="chef-header">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h2 class="title text-white">Nearby <b>TRENDING CUISINES</b></h2></div>
            </div>
        </div>
                        ...
                        <div class="col-md-3">
                            <div class="bestdishes-box">
                                ...
                                <div class="bestdishes-img progressive">
                                    ...
                                    <img src="{{URL::to('public/upload/item/'.$row->item_image)}}" class="progressive__img progressive--not-loaded img-fluid" alt="">
