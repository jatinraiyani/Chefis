...
@section('front_title') Search Result List @endsection
@section('front_css')
@endsection
@section('content')
    <section class="chef-header">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h2 class="text-white">Search List</h2>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="chef_data">
                            <div class="row">
                                @forelse($chef as $row)
                                                        ...
                                                        <div class="row">
                                                            <div class="pl-0 col-6">
                                                                <div class="review-box">
                                                                    ...
                                                                    <span><i class="fa fa-star" aria-hidden="true"></i> {{$row->rating}}</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                    ...
                                    @empty
                                    <div class="col-md-12 text-center"><h5>No Result Found.</h5></div>
                                @endforelse
                            </div>
                        </div>
                    </div>
