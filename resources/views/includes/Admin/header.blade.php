            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto">
                    ...
                    @elseif(Auth::user()->hasRole('chef'))
                        <a class="navbar-brand" href="{{URL::to('chef-admin')}}">
                    @endif
                        <img class="brand-logo" alt="modern admin logo"
                             src="{{URL::to('public/Adminassets/images/logo/logowhite.png')}}">
                        <h3 class="brand-text">Chefis</h3>
                        </a>
                </li>
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{URL::to('public/Adminassets/images/portrait/small/avatar-s-19.png')}}"
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{URL::to('public/Adminassets/images/portrait/small/avatar-s-2.png')}}"
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{URL::to('public/Adminassets/images/portrait/small/avatar-s-3.png')}}"
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{URL::to('public/Adminassets/images/portrait/small/avatar-s-6.png')}}"
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span class="avatar avatar-online">
                              @if(file_exists(public_path('upload/user/'.Auth::user()->profile_img)) && Auth::user()->profile_img != '')
                                    <img src="{{URL::to('public/upload/user/'.Auth::user()->profile_img)}}" alt="user">
                                @else
                                    <img src="{{URL::to('public/default/default_user.png')}}" alt="user">
                                @endif
                                <i></i>
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            @if(Auth::user()->hasRole('admin'))
                                <a class="dropdown-item" href="{{URL::to('admin/user/'.Auth::user()->id.'/edit')}}"><i
                                        class="ft-user"></i> Edit Profile</a>
                                <a class="dropdown-item" href="{{URL::to('admin/lock')}}"><i class="ft-lock"></i> Lock </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{URL::to('admin/logout')}}"><i class="ft-power"></i> Logout</a>
                            @elseif(Auth::user()->hasRole('chef'))
                                <a class="dropdown-item" href="{{URL::to('chef-admin/user/'.Auth::user()->id.'/edit')}}"><i
                                        class="ft-user"></i> Edit Profile</a>
                                <a class="dropdown-item" href="{{URL::to('chef-admin/lock')}}"><i class="ft-lock"></i> Lock </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{URL::to('chef-admin/logout')}}"><i class="ft-power"></i> Logout</a>
                            @endif
