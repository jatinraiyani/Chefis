...
<head>
    ...
    <title>Recover Password - Chefis Admin Panel
    </title>
            ...
            <section class="flexbox-container">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="login-box box-shadow-2 p-0">
                        <div class="">
                            <div class="theme-bg  card-header border-0 pb-0">
                                <div class="card-title text-center">
                                    <img src="{{URL::to('public/Adminassets/images/logo/logo.png')}}" alt="branding logo">
                                </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form-horizontal" action="" novalidate>
                                        ...
                                        <button type="submit" class="btn btn-info btn-lg btn-block"><i class="ft-unlock"></i> Recover Password</button>
                                    </form>
                                </div>
                            </div>
                            <div class="card-footer border-0 pb-3">
                                <p class="float-sm-left text-center"><a href="{{URL::to('admin/login')}}" class="card-link">Login</a></p>
