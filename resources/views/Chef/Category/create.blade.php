                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <section class="input-validation">
                                {{Form::open(array('url'=>'chef-admin/category','method'=>'POST','class'=>'form form-horizontal row-separator','novalidate','files'=>'true'))}}
                                @if(!empty($errors->all()))
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    {{Form::text('category_name','',array('class'=>'form-control','id'=>'userinput1','placeholder'=>'Category Name','required'=>'true','data-validation-required-message'=>"Category Name field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="phone_number">Category Description</label>
                                                <div class="col-md-9">
                                                    {{Form::text('category_description','',array('class'=>'form-control','id'=>'phone_number','placeholder'=>'Category Description','required'=>'true','data-validation-required-message'=>"Category Description field is required"))}}
                                                </div>
                                            </div>
