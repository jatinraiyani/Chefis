                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <section class="input-validation">
                                {{Form::open(array('url'=>'chef-admin/item','method'=>'POST','class'=>'form form-horizontal row-separator','novalidate','files'=>'true'))}}
                                @if(!empty($errors->all()))
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        {{Form::hidden('chef_id',Auth::user()->id)}}
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="category">Category
                                                    Name</label>
                                                <div class="col-md-9">
                                                    <button type="button"
                                                    ...
                                                    {{--{{Form::seect('category_id',$category,'',array('class'=>'form-control','id'=>'category','required'=>'true','data-validation-required-message'=>"Name field is required"))}}--}}
                                                </div>
                                            </div>
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button"
                                                                    class="btn btn-outline-primary add_cuisines"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="item_preparation_time">Item
