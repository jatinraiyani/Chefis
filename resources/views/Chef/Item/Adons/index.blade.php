    ...
    <div class="content-header row">
            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{URL::to('chef-admin/item')}}">Items</a>
                        </li>
        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <a href="{{URL::to('chef-admin/item/'.$id.'/adons/create')}}">
                                ...
                                @foreach($data as $row)
                                    <tr>
                                        ...
                                        <td rowspan="{{count($row->subadons) + 1}}">
                                            <a href="{{URL::to('chef-admin/item/'.$id.'/adons/'.$row->id.'/edit')}}"
                                               data-toggle="tooltip"
                                               data-placement="right" title="Edit Item Adons "> <i
                                                    class="ft ft-edit-3"></i></a> &nbsp;
                                            <a href="{{URL::to('chef-admin/item/'.$id.'/adons/'.$row->id.'/destroy')}}"
                                               data-toggle="tooltip"
