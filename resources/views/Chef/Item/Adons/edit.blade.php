                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <section class="input-validation">
                                {{Form::open(array('url'=>'chef-admin/item/'.$item.'/adons/'.$id.'/update','method'=>'PUT','class'=>'form form-horizontal row-separator','files'=>'true'))}}
                                @if(!empty($errors->all()))
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            {{Form::number('old_sub_price[]',$row->price,array('class'=>'form-control border-primary','id'=>'sub_price','data-id'=>'sub-'.$row->id,'placeholder'=>'Price','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        {{Form::text('sub_price[]','',array('class'=>'form-control border-primary','id'=>'sub_price','data-id'=>'sub-0','placeholder'=>'Price'))}}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-1">
                                ...
                                <div class="form-actions right">
                                    <a href="{{URL::to('chef-admin/item/'.$item.'/adons')}}" class="btn btn-warning mr-1">
