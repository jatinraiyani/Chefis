            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{URL::to('admin/order')}}">Order</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#">Edit Order</a>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="row-separator-colored-controls">Order Profile</h4>
                    </div>
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <section class="input-validation">
                                {{Form::open(array('url'=>'admin/order/'.$data['id'],'method'=>'PUT','class'=>'form form-horizontal row-separator','novalidate','files'=>'true'))}}
                                @if(!empty($errors->all()))
                                ...
                                @endif
                                <div class="form-body">
                                    <h4 class="form-section"><i class="la la-eye"></i> About Order</h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="payment_type">Order
                                                    Type</label>
                                                <div class="col-md-9">
                                                    {{Form::text('payment_type',$data['payment_type'],array('class'=>'form-control','id'=>'payment_type','placeholder'=>'Order Type','required'=>'true','data-validation-required-message'=>"Order Description field is required",'readonly'=>'true'))}}
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="amount">Order
                                                    Amount</label>
                                                <div class="col-md-9">
                                                    {{Form::text('amount',$data['amount'],array('class'=>'form-control','id'=>'amount','placeholder'=>'Order Amount','required'=>'true','data-validation-required-message'=>"Order Description field is required",'readonly'=>'true'))}}
                                                </div>
                                            </div>
                                    ...
                                    <h4 class="form-section"><i class="la la-envelope"></i> Order Details</h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="payment_id">Order
                                                    ID</label>
                                                <div class="col-md-9">
                                                    {{Form::text('payment_id',$data['payment_id'],array('class'=>'form-control','id'=>'payment_id','placeholder'=>'Order ID','required'=>'true','data-validation-required-message'=>"Order ID field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    {{Form::select('payment_status',array(''=>'Select Order Status','pending'=>'Pending','success'=>'Success','failed'=>'Failed'),$data['payment_status'],array('class'=>'form-control','id'=>'payment_status','required'=>'true','data-validation-required-message'=>"Order Status field is required"))}}
                                                </div>
                                            </div>
                                ...
                                <div class="form-actions right">
                                    <a href="{{URL::to('admin/payment')}}" class="btn btn-warning mr-1">
