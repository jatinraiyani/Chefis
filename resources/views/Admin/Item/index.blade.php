                                ...
                                <table class="table table-striped table-bordered file-export">
                                    ...
                                    @foreach($data as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{URL::to('admin/item/'.$row->id.'/status')}}">
                                                    <span
                                            ...
                                            <td>
                                              <div class="media-left">
                                                  @if(file_exists(public_path('upload/item/'.$row->item_image)) && $row->item_image != '')
                                                        <a href="javascript:void(0)" class="myImg viewimgage" data-src="{{URL::to('public/upload/item/'.$row->item_image)}}">view image
                                                        <i class="ft-eye"></i></a>
                                                  @else
                                            ...
                                            <td>
                                                <a href="{{URL::to('admin/item/'.$row->id.'/adons')}}"
                                                   data-toggle="tooltip"
                                                ...
                                                <a href="javascript:void(0)"
                                                   data-id="{{$row->id}}"
                                                   data-placement="left" onclick="deleteitem('{{$row->id}}')" title="Delete Item" id="cancel-button"><i
