...
@section('css')
    ...
    <link rel="
          stylesheet" type="text/css" href="{{URL::asset('public/Adminassets/css/core/colors/palette-switch.min.css')}}">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <section class="input-validation">
                                {{Form::open(array('url'=>'admin/item/'.$data['id'],'method'=>'PUT','class'=>'form form-horizontal row-separator','novalidate','files'=>'true'))}}
                                @if(!empty($errors->all()))
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="userinput1">Chef Name</label>
                                                <div class="col-md-9">
                                                    {{Form::select('chef_id',$chef,$data['chef_id'],array('class'=>'form-control','id'=>'userinput1','required'=>'true','data-validation-required-message'=>"Name field is required"))}}
                                                </div>
                                            </div>
...
{{--{{Form::select('category_id',$category,$data['category_id'],array('class'=>'form-control','id'=>'category','required'=>'true','data-validation-required-message'=>"Name field is required"))}}--}}
                                                                ...
                                                                @forelse($cuisine as $row)
                                                                    <div class="col-md-2" style="padding: 10px;">
                                                                        <div class="custom-control custom-checkbox">
                                                                            @if(in_array($row->id,$item_cuisine))
                                                                            <input type="checkbox"
                                                                                   class="custom-control-input"
                                                                                   name="cuisines[]"
                                                                                   value="{{$row->id}}"
                                                                                   id="customCheck{{$row->id}}" data-value="{{$row->cuisine_name}}" checked>
                                                                            @else
                                                                                <input type="checkbox"
                                                                                       class="custom-control-input"
                                                                                       name="cuisines[]"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    {{Form::text('item_name',$data['item_name'],array('class'=>'form-control','id'=>'item_name','placeholder'=>'Item Name','required'=>'true','data-validation-required-message'=>"Email field is required"))}}
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="item_price">Item Price</label>
                                                <div class="col-md-9">
                                                    {{Form::text('item_price',$data['item_price'],array('class'=>'form-control','id'=>'item_price','placeholder'=>'Item Price','required'=>'true','data-validation-required-message'=>"Email field is required"))}}
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    {{Form::text('item_preparation_time',$data['item_preparation_time'],array('class'=>'form-control','id'=>'item_preparation_time','placeholder'=>'Item Preparation Time (in minute)','required'=>'true','data-validation-required-message'=>"Email field is required"))}}
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="profile_pic">Item Image</label>
                                                <div class="col-md-9">
                                                    {{Form::file('item_image',array('class'=>'form-control','id'=>'profile_pic'))}}
                                                    <img
                                                        src="{{URL::to('public/upload/item/'.$data['item_image'])}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="item_description">Item Description</label>
                                                <div class="col-md-9">
                                                    {{Form::textarea('item_description',$data['item_description'],array('class'=>'form-control','id'=>'item_description','placeholder'=>'Item Description','required'=>'true','data-validation-required-message'=>"Email field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <h4 class="form-section"><i class="la la-envelope"></i> Item Info</h4>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    @if(count($item_on_demands) > 0)
                                                    <?php $d = Config::get('constant.day'); ?>
                                                    @foreach($item_on_demands as $key1 => $value)
                                                        <div class="row">
                                                            <div class="col-1 p-r-zero mt-1">
                                                                <p class="text-defualt pull-left"> {{$value['day']}}</p>
                                                                {{Form::hidden('days[]',$value['day'])}}
                                                            </div>
                                                            <div class="col-auto selecthours p-r-zero mt-1">
                                                                ...
                                                                <div class="float-left">
                                                                    <input type="checkbox" name="status1[<?=$d[$key1]?>][]"
                                                                           ...
                                                                           data-id="{{$key1}}" {{$value['status']=='open' ?'checked="checked"' :''}}/>
                                                                    <input type="hidden" name="status[<?=$d[$key1]?>][]" class="status1"
                                                                           data-id="{{$key1}}" value="{{$value['status']}}"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-auto selecthours p-r-zero mt-1">
                                                                <!--{{Form::select('f_start_time[]',[''=>'00:00']+Config::get('constant.time'),$value['first_open'],array('class'=>'form-control f_start_time','data-id'=>$key1))}}-->

                                                                <?=Form::select('f_start_time['.$d[$key1].'][]',['00:00'=>'00:00']+Config::get('constant.time'),$value['first_open'],array('class'=>'form-control f_start_time','data-id'=>$key1))?>

                                                            </div>
                                                            <div class="pull-left mt-2"><span class="tospan">To</span>
                                                            </div>
                                                            <div class="col-auto selecthours p-r-zero mt-1">
                                                                <!--{{Form::select('f_end_time[]',[''=>'00:00']+Config::get('constant.time'),$value['first_close'],array('class'=>'form-control f_end_time','data-id'=>$key1))}}-->
                                                                <?=Form::select('f_end_time['.$d[$key1].'][]',['00:00'=>'00:00']+Config::get('constant.time'),$value['first_close'],array('class'=>'form-control f_end_time','data-id'=>$key1))?>
                                                            </div>
                                                            <div class="col-auto selecthours p-r-zero mt-1">
                                                                <!--{{Form::text('f_qty[]',$value['first_qty'],array('class'=>'form-control f_qty','data-id'=>$key1,'placeholder'=>'Quantity'))}}-->
                                                                <?=Form::number('f_qty['.$d[$key1].'][]',$value['first_qty'],array('class'=>'form-control f_qty','data-id'=>$key1,'placeholder'=>'Quantity','min'=>'0','required'=>'required'))?>
                                                            </div>
                                                            <div class="col-auto selecthours p-r-zero mt-1">
                                                                <!--{{Form::select('s_start_time[]',[''=>'00:00']+Config::get('constant.time'),$value['second_open'],array('class'=>'form-control s_start_time','data-id'=>$key1))}}-->
                                                                <?=Form::select('s_start_time['.$d[$key1].'][]',['00:00'=>'00:00']+Config::get('constant.time'),$value['second_open'],array('class'=>'form-control s_start_time','data-id'=>$key1))?>
                                                            </div>
                                                            <div class="pull-left mt-2"><span class="tospan">To</span>
                                                            </div>
                                                            <div class="col-auto selecthours p-r-zero mt-1">
                                                                <!--{{Form::select('s_end_time[]',[''=>'00:00']+Config::get('constant.time'),$value['second_close'],array('class'=>'form-control s_end_time','data-id'=>$key1))}}-->
                                                                <?=Form::select('s_end_time['.$d[$key1].'][]',['00:00'=>'00:00']+Config::get('constant.time'),$value['second_close'],array('class'=>'form-control s_end_time','data-id'=>$key1))?>
                                                            </div>
                                                            <div class="col-auto selecthours p-r-zero mt-1">
                                                                <!--{{Form::text('s_qty[]',$value['second_qty'],array('class'=>'form-control s_qty','data-id'=>$key1,'placeholder'=>'Quantity'))}}-->
                                                                <?=Form::number('s_qty['.$d[$key1].'][]',$value['second_qty'],array('class'=>'form-control s_qty','data-id'=>$key1,'placeholder'=>'Quantity','min'=>'0','required'=>'required'))?>
                                                            </div>
                                                        ...
                                                        @foreach(Config::get('constant.day') as $key1 => $value)
                                                            <div class="row">
                                                                ...
                                                                <div class="col-auto selecthours p-r-zero mt-1">
                                                                    ...
                                                                    <?=Form::number('f_qty['.$d[$key1].'][]',0,array('class'=>'form-control f_qty','data-id'=>$key1,'placeholder'=>'Quantity','min'=>'0','required'=>'required'))?>
                                                                </div>
                                                                <div class="col-auto selecthours p-r-zero mt-1">
                                                                ...
                                                                <div class="col-auto selecthours p-r-zero mt-1">
                                                                    ...
                                                                    <?=Form::number('s_qty['.$d[$key1].'][]',0,array('class'=>'form-control s_qty','data-id'=>$key1,'placeholder'=>'Quantity','min'=>'0','required'=>'required'))?>
                                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    @if(count($item_time) > 0)
                                                        ...
                                                        @foreach($item_time as $key1 => $value)
                                                            <div class="row">
                                                                <div class="col-1 p-r-zero mt-1">
                                                                    <p class="text-defualt pull-left"> {{$value['day']}}</p>
                                                                    {{Form::hidden('d_days[]',$value['day'],array('class' => 'hidden_d_day'))}}
                                                                </div>
                                                                <div class="col-auto selecthours p-r-zero mt-1">
                                                                    {{--{{Form::select('status[]',['open'=>'Open','close'=>'Close'],'',array('class'=>'form-control status','data-id'=>$key1))}}--}}
                                                                    <div class="float-left">
                                                                ...
                                                                <div class="col-auto selecthours p-r-zero mt-1">
                                                                    <!--{{Form::select('start_time[]',[''=>'00:00']+Config::get('constant.time'),$value['open'],array('class'=>'form-control start_time','data-id'=>$key1))}}-->
                                                                    <?=Form::select('start_time['.$d[$key1].'][]',['00:00'=>'00:00']+Config::get('constant.time'),$value['open'],array('class'=>'form-control start_time','data-id'=>$key1))?>
                                                                </div>
                                                                <div class="pull-left mt-2"><span class="tospan">To</span>
                                                                </div>
                                                                <div class="col-auto selecthours p-r-zero mt-1">
                                                                    <!--{{Form::select('end_time[]',[''=>'00:00']+Config::get('constant.time'),$value['close'],array('class'=>'form-control end_time','data-id'=>$key1))}}-->
                                                                    <?=Form::select('end_time['.$d[$key1].'][]',['00:00'=>'00:00']+Config::get('constant.time'),$value['close'],array('class'=>'form-control end_time','data-id'=>$key1))?>
                                                                </div>

                                                                <div class="col-auto selecthours p-r-zero mt-1">
                                                                    <!--{{Form::select('deliver_day[]',[''=>'Select Day']+Config::get('constant.day'),$key1,array('class'=>'form-control start_time','data-id'=>$key1))}}-->
                                                                    <?=Form::select('deliver_day['.$d[$key1].'][]',[''=>'Select Day']+Config::get('constant.day'),$value->delivered_day,array('class'=>'form-control day','data-id'=>$key1,'data-day'=>$d[$key1]))?>
                                                                </div>
                                                                <div class="col-auto selecthours p-r-zero mt-1">
                                                                    <!--{{Form::select('d_time[]',[''=>'00:00']+Config::get('constant.time'),$value['delivered_time'],array('class'=>'form-control d_time','data-id'=>$key1))}}-->
                                                                    <?=Form::select('d_time['.$d[$key1].'][]',['00:00'=>'00:00']+Config::get('constant.time'),$value['delivered_time'],array('class'=>'form-control d_time','data-id'=>$key1))?>
                                                                </div>

                                                                <div class="col-auto selecthours p-r-zero mt-1">
                                                                    <!--{{Form::text('d_qty[]',$value['qty'],array('class'=>'form-control qty','data-id'=>$key1,'placeholder'=>'Quantity'))}}-->
                                                                    <?=Form::number('d_qty['.$d[$key1].'][]',$value['qty'],array('class'=>'form-control qty','data-id'=>$key1,'placeholder'=>'Quantity','min'=>'0','required'=>'required'))?>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                        @else
                                                    @foreach(Config::get('constant.day') as $key1 => $value)
                                                        <div class="row">
                                                            ...
                                                            <div class="col-auto selecthours p-r-zero mt-1">
                                                                ...
                                                                <?=Form::number('d_qty['.$d[$key1].'][]',0,array('class'=>'form-control qty','data-id'=>$key1,'placeholder'=>'Quantity','min'=>'0','required'=>'required'))?>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                        @endif
    ...
    <script>
        $(document).on('change', '.status', function () {
            ...
            if ($('.status[data-id=' + id + ']').prop('checked') == false) {
                ...
                $('.f_qty[data-id=' + id + ']').prop('required', false);
                $('.f_qty[data-id=' + id + ']').removeAttr('min');
                $('.s_qty[data-id=' + id + ']').prop('disabled', 'disabled');
                $('.s_qty[data-id=' + id + ']').removeAttr('required');
                $('.s_qty[data-id=' + id + ']').removeAttr('min');
                ...
                $('.f_qty[data-id=' + id + ']').prop('required', true);
                $('.f_qty[data-id=' + id + ']').attr('min',1);
                $('.s_qty[data-id=' + id + ']').prop('disabled', false);
                $('.s_qty[data-id=' + id + ']').prop('required', true);
                $('.s_qty[data-id=' + id + ']').attr('min',1);
