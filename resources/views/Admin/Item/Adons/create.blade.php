                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <section class="input-validation">
                                {{Form::open(array('url'=>'admin/item/'.$id.'/adons/store','method'=>'POST','class'=>'form-horizontal','files'=>'true'))}}
                                @if(!empty($errors->all()))
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    {{Form::text('title','',array('class'=>'form-control border-primary','id'=>'title','placeholder'=>'Title','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="box_type">Box Type</label>
                                                <div class="col-md-9">
                                                    {{Form::select('box_type',array(''=>'Select Box Type','checkbox'=>'Multiple Select','radio'=>'Single Select'),'',array('class'=>'form-control border-primary','id'=>'box_type','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="box_validation">Box
                                                    Validation</label>
                                                <div class="col-md-9">
                                                    {{Form::select('box_validation',array(''=>'Select Box Validation','yes'=>'Yes','no'=>'No'),'',array('class'=>'form-control border-primary','id'=>'box_validation','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    {{Form::select('status',array(''=>'Select Status','active'=>'Active','inactive'=>'Inactive'),'',array('class'=>'form-control border-primary','id'=>'status','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="subadons">
                                        <div class="row">
                                            <div class="col-md-4 ml-5">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="sub_name">Sub adons Name</label>
                                                    <div class="col-md-9">
                                                        {{Form::text('sub_name[]','',array('class'=>'form-control border-primary','id'=>'sub_name','data-id'=>'sub-0','required'=>'true','data-validation-required-message'=>"This field is required",'placeholder'=>'Sub Adons Name'))}}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        {{Form::number('sub_price[]','',array('class'=>'form-control border-primary','min'=>'0','id'=>'sub_price','data-id'=>'sub-0','placeholder'=>'Price','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="form-actions right">
                                    <a href="{{URL::to('admin/item/'.$id.'/adons')}}" class="btn btn-warning mr-1">
