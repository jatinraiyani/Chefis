            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{URL::to('admin/item/'.$id)}}">Adons</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#">Edit Adons</a>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <section class="input-validation">
                                {{Form::open(array('url'=>'admin/item/'.$item.'/adons/'.$id.'/update','method'=>'PUT','class'=>'form form-horizontal row-separator','files'=>'true'))}}
                                @if(!empty($errors->all()))
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    {{Form::text('title',$data['title'],array('class'=>'form-control border-primary','id'=>'userinput1','placeholder'=>'Title','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    {{Form::select('box_type',array(''=>'Select Box Type','checkbox'=>'Multiple Select','radio'=>'Single Select'),$data['box_type'],array('class'=>'form-control border-primary','id'=>'userinput1','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="userinput1">Box
                                                    Validation</label>
                                                <div class="col-md-9">
                                                    {{Form::select('box_validation',array(''=>'Select Box Validation','yes'=>'Yes','no'=>'No'),$data['box_validation'],array('class'=>'form-control border-primary','id'=>'userinput1','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    {{Form::select('status',array(''=>'Select Status','active'=>'Active','inactive'=>'Inactive'),$data['status'],array('class'=>'form-control border-primary','id'=>'userinput1','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="subadons">
                                        @foreach($subdata as $row)
                                            ...
                                            <div class="row">
                                                {{Form::hidden('old_sub_id[]',$row->id)}}
                                                <div class="col-md-4 ml-5">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="userinput5">Sub adons
                                                            Name</label>
                                                        <div class="col-md-9">
                                                            {{Form::text('old_sub_name[]',$row->name,array('class'=>'form-control border-primary','id'=>'sub_name','data-id'=>'sub-'.$row->id,'placeholder'=>'Sub Adons Name','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control"
                                                               for="userinput5">Price</label>
                                                        <div class="col-md-9">
                                                            {{Form::number('old_sub_price[]',$row->price,array('class'=>'form-control border-primary','min'=>'0','id'=>'sub_price','data-id'=>'sub-'.$row->id,'placeholder'=>'Price','required'=>'true','data-validation-required-message'=>"This field is required"))}}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mt-1">
                                                    <a href="" class="btn btn-danger mr-1 delete_subadons">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 ml-5">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="userinput5">Sub adons
                                                        Name</label>
                                                    <div class="col-md-9">
                                                        {{Form::text('sub_name[]','',array('class'=>'form-control border-primary','id'=>'sub_name','data-id'=>'sub-0','placeholder'=>'Sub Adons Name'))}}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        {{Form::number('sub_price[]','',array('class'=>'form-control border-primary','id'=>'sub_price','data-id'=>'sub-0','placeholder'=>'Price','min'=>'0'))}}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-2 mt-1">
                                                <a href="" class="btn btn-success mr-1 add_subadons">
                                ...
                                <div class="form-actions right">
                                    <a href="{{URL::to('admin/item/'.$item.'/adons')}}" class="btn btn-warning mr-1">
