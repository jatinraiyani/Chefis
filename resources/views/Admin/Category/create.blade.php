            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{URL::to('admin/category')}}">Category</a>
                        </li>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <section class="input-validation">
                                {{Form::open(array('url'=>'admin/category','method'=>'POST','class'=>'form form-horizontal row-separator','novalidate','files'=>'true'))}}
                                @if(!empty($errors->all()))
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    {{Form::select('chef_id',$chef,'',array('class'=>'form-control','id'=>'chef_id','required'=>'true','data-validation-required-message'=>"Category Name field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="category_name">Name</label>
                                                <div class="col-md-9">
                                                    {{Form::text('category_name','',array('class'=>'form-control','id'=>'category_name','placeholder'=>'Category Name','required'=>'true','data-validation-required-message'=>"Category Name field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="category_description">Category Description</label>
                                                <div class="col-md-9">
                                                    {{Form::textarea('category_description','',array('class'=>'form-control','id'=>'category_description','placeholder'=>'Category Description','required'=>'true','data-validation-required-message'=>"Category Description field is required"))}}
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="profile_pic">Category Image</label>
                                                <div class="col-md-9">
