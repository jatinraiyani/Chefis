...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">User View</h3>
    ...
    <div id="user-profile">
        <div class="row">
            ...
            <div class="col-xl-12 col-12 mt-2">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title text-center">User Account Details</h4>
                    </div>
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-4 text-center">
                                    <h4 class="font-large-2 text-bold-400">{{number_format($totalwishlist)}}</h4>
                                    <p class="blue-grey lighten-2 mb-0">Total Wishlist Item</p>
                                </div>
                                ...
                                <div class="col-md-4 col-4 border-right-blue-grey border-right-lighten-5 text-center">
                                    ...
                                    <p class="blue-grey lighten-2 mb-0">Total Purchase</p>
                                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Userwist List</h4>
