...
<head>
    ...
    <title>Login - Chefis Admin Panel
    </title>
                    ...
                    <div class="login-box box-shadow-2 p-0">
                        <div class="card  border-grey border-lighten-3 m-0">
                            ...
                            <div class="card-content theme-bg">
                                <div class="card-body">
                                    {{Form::open(array('url'=>'admin/login','method'=>'POST','class'=>'form-horizontal form-simple','novalidate'))}}
                                    @if(!empty($errors->all()))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-12 text-center text-md-right"><a
                                                href="{{URL::to('admin/recover')}}" class="card-link">Forgot Password?</a>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                <div class="">
                                    <p class="float-sm-left text-center m-0"><a href="{{URL::to('admin/recover')}}"
