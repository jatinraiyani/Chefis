...
<head>
    ...
    <title>Unlock - Chefis Admin Panel
    </title>
                    ...
                    <div class="lock-box  box-shadow-2 p-0">
                        <div class="card theme-bg border-grey border-lighten-3 px-2 py-2 m-0">
                            ...
                            <div class="card-content theme-bg">
                                <div class="card-body">
                                    {{Form::open(array('url'=>'admin\lock','method'=>'POST','class'=>'form-horizontal','novalidate'=>'true'))}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-11 col-12 float-sm-left text-center text-sm-right"><a href="{{URL::to('admin/recover')}}" class="text-white -link"><i class="ft-unlock"></i> Forgot Password?</a></div>
                                    </div>
                                    {{Form::submit('Unlock',array('class'=>'btn btn-primary btn-lg btn-block'))}}
                                    <a href="{{URL::to('admin/logout')}}" class="btn btn-danger btn-lg btn-block"><i class="ft-power"></i> Logout</a>
                                    {{Form::close()}}
                                </div>
                            </div>
                        </div>
