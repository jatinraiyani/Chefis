...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{URL::to('public/Adminassets/fonts/meteocons/style.min.css')}}">
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-8">
          <a href="{{URL::to('admin/user-chef')}}">
            <div class="card pull-up">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left">
                                <h6 class="text-muted">Total Chefs </h6>
                                <h3>{{number_format($chef)}}</h3>
                            </div>
                            <div class="align-self-center">
                                <i class="icon-fire success font-large-2 float-right"></i>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-3 col-8">
          <a href="{{URL::to('admin/user-driver')}}">
            <div class="card pull-up">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            ...
                            <div class="align-self-center">
                                <i class="icon-plane danger font-large-2 float-right"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card pull-up">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left">
                                <h6 class="text-muted">Total Cuisines</h6>
                    ...
                    {{--<div class="card-body">--}}
                        {{--<div class="media d-flex">--}}
                            {{--<div class="media-body text-left">--}}
                                ...
                                {{--<h3>{{number_format($category)}}</h3>--}}
                            {{--</div>--}}
                            {{--<div class="align-self-center">--}}
                                {{--<i class="ft ft-sliders danger font-large-2 float-right"></i>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
                    ...
                    <div class="table-responsive">
                        <table id="recent-orders" class="table table-hover table-xl mb-0">
                            ...
                            @foreach($transaction as $row)
                                <tr>
                                <td class="text-truncate"><i class="fa fa-dot-circle-o {{$row->payment_status == 'success' ? 'success' : ($row->payment_status == 'failed' ? 'danger' : 'warning')}} font-medium-1 mr-1"></i>{{$row->payment_status}}</td>
                                <td class="text-truncate"><a href="{{URL::to('admin/order/'.$row->id)}}">#{{$row->order_number}}</a></td>
                                ...
                                <td class="text-truncate">{{$row->payment_type}}</td>
                                <td class="text-truncate">{{$row->payment_id}}</td>
                                <td class="text-truncate">$ {{number_format(round($row->order_final_total))}}</td>
                            </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="table-responsive">
                        <table id="recent-orders" class="table table-hover table-xl mb-0">
                            ...
                            <tr>
                                <th class="border-top-0">Invoice#</th>
                                <th class="border-top-0">Customer Name</th>
                                <th class="border-top-0">Chef Name</th>
                                <th class="border-top-0">Products</th>
                                <th class="border-top-0">Transaction ID</th>
                            ...
                            @foreach($order_data as $row)
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                      <span class="avatar avatar-xs">
                                           @if(file_exists(public_path('upload/user/'.$row->chefData->profile_img)) && $row->chefData->profile_img != '')
                                              <img src="{{URL::to('public/upload/user/'.$row->chefData->profile_img)}}"
                                                   class="box-shadow-2" alt="user">
                                          @else
                                              <img src="{{URL::to('public/default/default_user.png')}}"
                                                   class="box-shadow-2"
