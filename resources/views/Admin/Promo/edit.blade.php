...
@section('content')
    <div class=" content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Promo</h3>
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{URL::to('admin/')}}">Home</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{URL::to('admin/promo')}}">Promo</a>
                        </li>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="row-separator-colored-controls">Promo</h4>
                </div>
                <div class="card-content collapse show">
                    <div class="card-body">

                        <section class="input-validation">
                          {{Form::open(array('url'=>'admin/promo/'.$data['id'],'method'=>'PUT','class'=>'form form-horizontal row-separator','novalidate'))}}
                            @if(!empty($errors->all()))
                            ...
                            @endif
                            <div class="form-body">
                                <h4 class="form-section"><i class="la la-eye"></i> About Promo</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-md-3 label-control" for="userinput1">Code</label>
                                            <div class="col-md-9">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-md-3 label-control" for="userinput1">Value</label>
                                            <div class="col-md-9">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-md-3 label-control" for="userinput1">Time/User</label>
                                            <div class="col-md-9">
                                              {{Form::text('time_per_user',$data->time_per_user,array('class'=>'form-control'))}}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                          ...
                                          <label class="col-md-3 label-control" for="userinput1">Start Date</label>
                                            <div class="col-md-9">
                                              <fieldset class="form-group form-group-style">
                                                <input type="date" name="start_date" value="{{$data->start_date}}" class="form-control" id="date12">
                                              </fieldset>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                          <label class="col-md-3 label-control" for="userinput1">End Date</label>
                                            <div class="col-md-9">
                                              <fieldset class="form-group form-group-style">
                                                <input type="date" name="end_date" value="{{$data->end_date}}" class="form-control" id="date13">
                                              </fieldset>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions right">
                                <a href="{{URL::to('admin/area')}}" class="btn btn-warning mr-1">
