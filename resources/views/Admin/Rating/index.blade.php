...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Chef Rating & Reviews</h3>
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{URL::to('admin/')}}">Home</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#">Chef Rating & Reviews</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Chef Rating & Reviews Table</h4>
                                            ...
                                            <td>
                                                @foreach(range(1,5) as $i)
                                                    <span class="fa-stack" style="width:1em">
                                                        ...
                                                        @if($row->rating_start >0)
                                                            @if($row->rating_start >0.5)
                                                                <i class="fa fa-star"
                                                                   style="color:#fbaf5d;"></i>
                                                            @else
                                                                <i class="fa fa-star-half-o"
                                                                   style="color:#fbaf5d;"></i>
                                                            @endif
                                                        @else
                                                            <i class="fa fa-star-o" style="color:#fbaf5d;"></i>
                                                        @endif

                                                        @php $row->rating_start--; @endphp
                                                    </span>
                                                @endforeach
                                            </td>
                                            <td>{{$row->chef_review}} </td>

                                            <td>
                                                <a href="#"
                                                   data-toggle="tooltip" data-id="{{$row->id}}"
                                                   data-placement="left" title="Delete Rating Review" class="cancel-button"><i
...
@section('script')
    ...
    <script>
        $('.cancel-button').on('click', function () {
            ...
            swal({
                title: "Are you sure?",
                text: "You will not be able to recover this Reviews Details!",
                icon: "warning",
                buttons: {
                    cancel: {
                        text: "No, cancel plx!",
                ...
                .then((isConfirm) => {
                    if (isConfirm) {
                        swal("Deleted!", "Your Reviews Details has been deleted.", "success");
                        window.location.href = "rating-review/" + id + "/destroy";
                    } else {
                        swal("Cancelled", "Your Reviews Details is safe", "error");
                    }
                });
