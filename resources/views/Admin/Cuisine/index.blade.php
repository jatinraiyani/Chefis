...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Cuisines</h3>
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{URL::to('admin/')}}">Home</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#">Cuisines</a>
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <a href="{{URL::to('admin/cuisine/create')}}">
                    <button class="btn btn-danger round btn-glow px-2"
                            type="button" aria-expanded="false"> + Add Cuisines
                    </button>
                </a>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Cuisines Table</h4>
                                ...
                                <table class="table table-striped table-bordered file-export">
                                    ...
                                    @foreach($data as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{URL::to('admin/cuisine/'.$row->id.'/status')}}">
                                                    <span
                                            ...
                                            <td>
                                                <div class="media-left">
                                                    @if(file_exists(public_path('upload/cuisine/'.$row->cuisine_image)) && $row->cuisine_image != '')
                                                        <img
                                                            src="{{URL::to('public/upload/cuisine/'.$row->cuisine_image)}}"
                                                            class="img-responsive" alt="Cuisine" height="50px"
                                                            width="50px">
                                                    @else
                                                        <img src="{{URL::to('public/default/default_Cuisine.png')}}"
                                            ...
                                            <td>
                                                <a href="{{URL::to('admin/cuisine/'.$row->id.'/edit')}}"
                                                   data-toggle="tooltip"
                                                   data-placement="right" title="Edit Cuisine"> <i
                                                        class="ft ft-edit-3"></i></a> &nbsp;
                                                <a href="#"
                                                   data-toggle="tooltip" data-id="{{$row->id}}"
                                                   data-placement="left" title="Delete Cuisine" class="cancel-button"><i
...
@section('script')
    ...
    <script>
        $('.cancel-button').on('click',function(){
            ...
            swal({
                title: "Are you sure?",
                text: "You will not be able to recover this Cuisine!",
                icon: "warning",
                buttons: {
                    cancel: {
                        text: "No, cancel plx!",
                ...
                .then((isConfirm) => {
                    if (isConfirm) {
                        swal("Deleted!", "Your Cuisine Item has been deleted.", "success");
                        window.location.href = "cuisine/" + id + "/destroy";
                    } else {
                        swal("Cancelled", "Your Cuisine Item is safe", "error");
                    }
                });
