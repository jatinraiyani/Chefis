            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Edit Cuisine</a>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <section class="input-validation">
                                {{Form::open(array('url'=>'admin/cuisine/'.$data['id'],'method'=>'PUT','class'=>'form form-horizontal row-separator','novalidate','files'=>'true'))}}
                                @if(!empty($errors->all()))
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    {{Form::text('cuisine_name',$data['cuisine_name'],array('class'=>'form-control','id'=>'userinput1','placeholder'=>'Category Name','required'=>'true','data-validation-required-message'=>"Category Name field is required"))}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="profile_pic">Cuisine
                                                    Image</label>
                                                <div class="col-md-9">
                                                    {{Form::file('cuisine_image',array('class'=>'form-control','id'=>'profile_pic'))}}
                                                    <img
                                                        src="{{URL::to('public/upload/cuisine/'.$data['cuisine_image'])}}"
