!function (e) {
    ...
    var i, s = {
            ...
            debug: !1
        }, o = {from: "Ã£Ã Ã¡Ã¤Ã¢áº½Ã¨Ã©Ã«ÃªÃ¬Ã­Ã¯Ã®ÃµÃ²Ã³Ã¶Ã´Ã¹ÃºÃ¼Ã»Ã±Ã§", to: "aaaaaeeeeeiiiiooooouuuunc"},
        n = ~window.navigator.appVersion.indexOf("MSIE 9."), r = ~window.navigator.appVersion.indexOf("MSIE 10"),
    ...
    l.prototype = {
        _validateCacheMethod: function (t) {
            ...
            if (this.filterGenerateSource(), Array.isArray(t) && t.length) this.generateGroups = t; else if (!this.generateGroups.length) return void this.node.trigger("search" + this.namespace);
            ...
            for (var v = 0, b = this.searchGroups.length; v < b; ++v) if (F = this.searchGroups[v], !this.filters.dropdown || "group" !== this.filters.dropdown.key || this.filters.dropdown.value === F) {
            ...
            if (this.options.cancelButton) {
                var e = this;
                j("<span/>", {
                    class: this.options.selector.cancelButton, html: "Ã—", mousedown: function (t) {
